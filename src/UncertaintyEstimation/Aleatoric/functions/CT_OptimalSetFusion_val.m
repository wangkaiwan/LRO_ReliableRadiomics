function [SEN,SPE,ACC,AUC,P_fin] = CT_OptimalSetFusion_val(FileName,wInd,lamda)
...
%     min_model = 10;
    [SEN,SPE,ACC,AUC] = CT_MyValdationAnalysis(wInd,Epal,EPOP,E_AUC,E_model,lamda,min_model,class,cli_sam_val_data,PET_sam_val_data,CT_sam_val_data,PET_ind_val_data,cli_n,pet_n,ct_n);
...
%         temp_ct = CT_sam_val_data(j,:)+0.025*randn(size(CT_sam_val_data(j,:)));
        ...
        p=CT_cal_single_probability(temp_cli,temp_pet,temp_ct,fin_POP,fin_model,cli_n,pet_n,ct_n);
