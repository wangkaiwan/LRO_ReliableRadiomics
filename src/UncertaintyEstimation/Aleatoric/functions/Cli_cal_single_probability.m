function p=Cli_cal_single_probability(single_test_data1,single_test_data2,single_test_data3,POP,model,cli_n,pet_n,ct_n)
...
%     Pro = [pro_output7];
%     pro_output = Analytic_ER_rule(w(i,7),w(i,7),Pro);
    Pro = [pro_output1;pro_output4;pro_output7];
    pro_output = Analytic_ER_rule(w(i,[1,4,7]),w(i,[1,4,7]),Pro);
    p(i,:)=pro_output;
end