function p=PET_cal_single_probability(single_test_data1,single_test_data2,single_test_data3,POP,model,cli_n,pet_n,ct_n)
...
%     
%     Pro = [pro_output8];
%     pro_output = Analytic_ER_rule(w(i,8),w(i,8),Pro);
    
    Pro = [pro_output2;pro_output5;pro_output8];
    pro_output = Analytic_ER_rule(w(i,[2,5,8]),w(i,[2,5,8]),Pro);
    p(i,:)=pro_output;
end