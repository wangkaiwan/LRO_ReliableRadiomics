function [SEN,SPE,ACC,AUC,P_fin] = PET_OptimalSetFusion(FileName,wInd,lamda)
...
%         r=cal_reliability(sam_train_data,ind_train_data,sam_test_data(j,:),10,fin_POP,fin_model);
        ...
        p=PET_cal_single_probability(cli_sam_test_data(j,:),PET_sam_test_data(j,:),...
            CT_sam_test_data(j,:),fin_POP,fin_model,cli_n,pet_n,ct_n);
