function [SEN,SPE,ACC,AUC] = CT_MyValdationAnalysis(wInd,Epal,EPOP,E_AUC,E_model,lamda,min_model,class,test_data_sam1,test_data_sam2,test_data_sam3,test_ind,cli_n,pet_n,ct_n)
...
%     r=cal_reliability(sam_train_data,ind_train_data,sam_test_data(j,:),10,fin_POP,fin_model);
    ...
    p=CT_cal_single_probability(test_data_sam1(j,:),test_data_sam2(j,:),test_data_sam3(j,:),fin_POP,fin_model,cli_n,pet_n,ct_n);
