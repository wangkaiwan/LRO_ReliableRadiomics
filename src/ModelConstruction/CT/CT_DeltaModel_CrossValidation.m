...
min_model=20;
pop_num=100;
it_num=1; % 1 is only for testing, please modify it to a bigger number
cross_num=5;
NA=20;
CS=500;
% fea_num = 30;
...
%             fprintf('Testing: ');
        ...
        save([outputpath, 'CT_Model_CV_',num2str(repeat_index),'_Fold_',num2str(c),'.mat']); 
    ...
    save([outputpath, 'CT_Model_CV_',num2str(repeat_index),'.mat'],'test_record');
end