...
%         load([dataPath,'\',folder{index},'\',fileName,'\CT\image\newImg.mat']);
        load([dataPath,'\',folder{index},'\',fileName,'\CT\image\oriImg_Pre.mat']);
        load([dataPath,'\',folder{index},'\',fileName,'\CT\RTS\oriContour_Pre.mat']);
...
fclose(fid);
save([dataPath,'\',folder{index},'\','CT_Feature_Record_Pre.mat'],'record');
save([dataPath,'\',folder{index},'\','CT_Feature_Scaled_Pre.mat'],'fin_fea');
end